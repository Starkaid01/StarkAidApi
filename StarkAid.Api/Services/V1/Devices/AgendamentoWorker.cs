    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var dispositivoEspService = scope.ServiceProvider.GetRequiredService<StarkAid.Api.Services.V1.DispositivoEsp.DispositivoEspService>();
                var ewelinkService = scope.ServiceProvider.GetRequiredService<StarkAid.Api.Services.V1.IEwelinkService>();
