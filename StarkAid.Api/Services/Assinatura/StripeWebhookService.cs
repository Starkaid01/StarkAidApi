...
namespace StarkAid.Api.Services.Assinatura
{
    public class StripeWebhookService
    {
        ...
        public StripeWebhookService(AppDbContext db, ILogger<StripeWebhookService> logger, IConfiguration config, StripeSettings stripeSettings)
        {
            _db = db;
            _logger = logger;
        ...
        private async Task HandleSubscriptionUpdated(Event stripeEvent)
        {
            ...
            if (subscription.Status == "canceled" || subscription.Status == "unpaid")
            {
                ...
                if(user != null && user.RemovalAds == "Ativo")
                {
        ...
        private async Task HandlePaymentSucceeded(Event stripeEvent)
        {
            ...
            user.Role = assinatura.Valor switch
            {
                5 => "UserNivel3",
                15 => "UserNivel4",
                25 => "UserNivel5",
